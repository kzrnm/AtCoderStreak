...
namespace AtCoderStreak.TestUtil
{
    class MockProgram : Program
    {
        ...
        public Mock<IDataService> DataMock { set; get; }
        public Mock<IStreakService> StreakMock { set; get; }
        public Logger Logger { get; }
        public CancellationTokenSource CancellationTokenSource { get; } = new();
        public void SetupCookie() => DataMock.Setup(d => d.GetSession()).Returns(cookie);

        public MockProgram() : this(new(), new(), new()) { }
        public MockProgram(Mock<IDataService> dataMock, Mock<IStreakService> streakMock, Logger logger) : base(dataMock.Object, streakMock.Object, logger)
        {
            DataMock = dataMock;
            StreakMock = streakMock;
            Logger = logger;
        }
    }
}
